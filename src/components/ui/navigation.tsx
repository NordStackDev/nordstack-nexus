    ...
    <nav className="border-b border-border bg-background/90 backdrop-blur-md supports-[backdrop-filter]:bg-background/60 sticky top-0 z-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex h-20 items-center justify-between">
          ...
          {/* Brand */}
          <Link to="/" className="flex items-center space-x-2 ml-4 sm:ml-6 md:ml-8">
            <div className="flex items-center justify-center">
              <img src="/nordstacklogonobg.png" alt="Nordstack" className="h-16 sm:h-20 md:h-24 w-auto block" />
            </div>
            <div className="hidden sm:block ml-2">
              <span className="text-xl font-bold text-foreground">Nordstack</span>
              <span className="text-sm text-muted-foreground block leading-tight">Pitch Sales Tracker</span>
            </div>
          </Link>
          ...
          <div className="flex items-center space-x-4">
            <Link
              ...
              className={cn(
                ...
                location.pathname === "/"
                  ? "bg-gradient-to-r from-[color:var(--primary)] to-[color:var(--primary-glow)] text-primary-foreground"
